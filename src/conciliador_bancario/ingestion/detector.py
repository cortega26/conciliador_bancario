...
from conciliador_bancario.ingestion.csv_adapter import cargar_movimientos_esperados_csv, cargar_transacciones_csv
...
from conciliador_bancario.ingestion.xlsx_adapter import cargar_movimientos_esperados_xlsx, cargar_transacciones_xlsx
...
def cargar_transacciones_bancarias(path: Path, *, cfg: ConfiguracionCliente, audit: JsonlAuditWriter) -> list[TransaccionBancaria]:
