# Como agregar un nuevo formato (sin hardcode por banco)
...
1. Implementar funcion `cargar_transacciones_*` o `cargar_movimientos_*`.
...
- Si hay ambiguedad -> error explicito o pendiente (fail-closed).
